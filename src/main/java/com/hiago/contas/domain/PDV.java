...
public class PDV {
	...
	public String toString() {
		...
		for (ItemVenda item : itens) {
			listaProdutos.append(item.getProduto().getDescricao()).append(" - qtd: ").append(item.getQuantidade())
					.append(", ");
		}

		return "PDV {" + "id='" + id + '\'' + ", cliente=" + (cliente != null ? cliente.getNome() : "N/A")
				+ ", produtos=" + listaProdutos + ", total=R$ " + valorTotal + ", data=" + dataHora.format(formatter)
				+ ", meioDePagamento=" + mdp + '}';
	}
